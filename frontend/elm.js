...
var $author$project$Main$fetchTasksRequest = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$Main$TasksFetched, $author$project$Main$tasksDecoder),
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'FetchTasks':
				return _Utils_Tuple2(model, $author$project$Main$fetchTasksRequest);
			case 'TasksFetched':
				if (msg.a.$ === 'Ok') {
					var tasks = msg.a.a;
...
var $author$project$Main$ToggleTask = function (a) {
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Main$ToggleTask(task.id))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onInput($author$project$Main$UpdateNewTask)
					]),
				_List_Nil),
				A2(
				$elm$html$Html$button,
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return _Utils_Tuple2($author$project$Main$initModel, $author$project$Main$fetchTasksRequest);
		},
